 ...
 infowindow = new google.maps.InfoWindow();
  for (i = 0; i < locArray.length; i++) {
    marker = new google.maps.Marker({
    		...
    		, wikiLink: '<br><a href=https://en.wikipedia.org/wiki/'+locArray[i].urlName+'>'+'Wikipedia Article'+'</a>'
        });
    ...
    // var wikiUrl = 'https://en.wikipedia.org/w/api.php?action=query&prop=revisions&format=json&rvprop=content&titles='+ locArray[i].urlName;
      // var wikiUrl = 'https://en.wikipedia.org/wiki/action=query&list=search&format=json&srsearch='+ locArray[i].urlName;
       //var wikiUrl = 'https://en.wikipedia.org/wiki/'+locArray[i].urlName;
